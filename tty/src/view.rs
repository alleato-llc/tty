...
use rime::theme;
use rime::widgets::{
    button, context_menu, dialog, modal_sized, rename_bar, rename_field_id, section, stat, table,
    tabs, text_field, window_shell, MenuItem, Tab, TabBarStyle, TableColumn, TableMetrics,
};
